...
- Bản đồ màn hình Start có ba camera mode: `follow` bám vị trí hiện tại, `route` fit toàn bộ route, và `free` khi người dùng tự pan/zoom. Hai nút nổi bên phải lần lượt định vị/bật lại follow và xem toàn tuyến; nút toàn tuyến chỉ khả dụng sau khi có ít nhất 2 điểm GPS. Không được tự kéo camera về GPS khi đang ở free mode.
