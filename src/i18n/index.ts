...
const vi = {
  ...
  recordedRoute: "LỘ TRÌNH GPS",
  routePoints: "điểm GPS",
  locateCurrentPosition: "Định vị vị trí hiện tại",
  showFullRoute: "Xem toàn bộ lộ trình",
  northUp: "Đưa hướng Bắc lên trên",
  northShort: "B",
  kilometerShort: "km",
  meterShort: "m",
  perKilometer: "/km",
